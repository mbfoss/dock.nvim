...
describe("dock", function()
    ...
    describe("shell", function()
        ...
        it("shares one tab across shells, one page each", function()
        ...
        it("labels a page with the command it runs", function()
            local group = dock.shell({ cmd = "echo 3" })
            assert.are.equal("echo 3", group.pages[#group.pages].label)
