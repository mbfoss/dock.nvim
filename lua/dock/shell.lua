...
---
--- Cleaning it wipes the terminal, since dock spawned that buffer and so it is
--- dock's to delete, but only once the shell has exited. A live shell keeps its
--- tab: the scrollback of a running command is not something a sweep should
--- take.
---@param label string
---@return dock.Group
